...
const ResumeState = (props) => {
    ...
    return (
        <ResumeContext.Provider value={{ themeData, setThemeData, initialData, checkProfile, setCheckProfile, checkLinkedin, setCheckLinkedin, checkGithub, setCheckGithub, selectBtn, setSelectBtn, checkAward, setCheckAward, componentRef, currentTheme, setCurrentTheme, showComponent, setShowComponent, loading, setLoading, themeData, setThemeData, checkProj, checkWork, setCheckProj, setCheckWork }}>
            {props.children}
